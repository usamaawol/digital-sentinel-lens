...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-oTN4dHNc.mjs");
...
const manifest = {
  "67ee2bc2fd76502dad327aed7a10543c97c458e1abdcee19d46cd162afc9ed2e": {
    functionName: "analyzePolicyFn_createServerFn_handler",
    importer: () => import("./ai.functions-D1ZPhkU3.mjs")
  },
  "7d2cba5301f18b93b7131c9882fd9fe6802b4a335d1702103e32b7cb86be26ae": {
    functionName: "chatFn_createServerFn_handler",
    importer: () => import("./ai.functions-D1ZPhkU3.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-x6rZinQA.mjs").then((n) => n.l),
    import("./start-BNf70Lc0.mjs"),
