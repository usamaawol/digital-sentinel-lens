...
import { u as useNavigate, O as Outlet, f as useRouterState, L as Link } from "./_libs/tanstack__react-router.mjs";
...
import { S as Separator } from "./_ssr/separator-FbHnBuBJ.mjs";
...
import { u as useAuth, B as BrandLogo, e as firestoreService } from "./_ssr/router-x6rZinQA.mjs";
...
import { L as LayoutDashboard, a as AppWindow, F as FileSearch, Z as Sparkles, B as Bell, O as Settings, u as LogOut, z as PanelLeft, a8 as X } from "./_libs/lucide-react.mjs";
...
function AppSidebar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { collapsible: "icon", className: "border-r border-sidebar-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarHeader, { className: "px-3 py-4", children: collapsed ? /* @__PURE__ */ jsxRuntimeExports.jsx(BrandLogo, { size: "sm" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(BrandLogo, { size: "md" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuButton, { asChild: true, isActive: isActive(item.url), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: item.url, className: "flex items-center gap-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: "h-4 w-4" }),
          "badge" in item && item.badge && unreadCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1.5 -right-1.5 h-3.5 w-3.5 rounded-full bg-destructive text-[8px] text-white grid place-items-center font-bold leading-none", children: unreadCount > 9 ? "9+" : unreadCount })
        ] }),
        !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex-1 flex items-center justify-between", children: [
          item.title,
          "badge" in item && item.badge && unreadCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto h-5 min-w-5 px-1 rounded-full bg-destructive text-[10px] text-white grid place-items-center font-bold", children: unreadCount > 99 ? "99+" : unreadCount })
        ] })
      ] }) }) }, item.url)) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarFooter, { className: "p-3 gap-2", children: [
      !collapsed && user && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-lg p-2.5 text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium truncate", children: user.displayName || user.email }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground truncate", children: user.email })
      ] }),
...
function AuthenticatedLayout() {
  ...
  if (loading || !user) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen grid place-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 text-muted-foreground text-sm", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex w-full", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "h-14 flex items-center gap-3 px-4 border-b border-border/60 glass sticky top-0 z-30", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarTrigger, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: "Privacy Guard Console" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 p-4 md:p-6 max-w-[1400px] w-full mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
    ] })
  ] }) });
}
export {
