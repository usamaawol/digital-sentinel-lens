...
import { FileSearch, Sparkles, Database, Share2, Clock, ShieldAlert, Lightbulb } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between flex-wrap gap-3">
        ...
        <div className="text-[11px] inline-flex items-center gap-1.5 rounded-full border border-border bg-muted/40 px-2.5 py-1 text-muted-foreground">
          <Sparkles className="h-3 w-3" /> Mock AI · OpenRouter pending
        </div>
      </div>
